...
enum ConfirmAction { Cancel, Next}
...
Future<ConfirmAction?> myconfirmdialog(BuildContext context)
{
  ...
  return showDialog<ConfirmAction>
    ...
    builder: (BuildContext context)
    {
      return AlertDialog
        (
        title: Text('Are you sure you want to Switch Next Page?'),
        content: const Text('Switching the new page'),
        actions:
        [
          ...
          ElevatedButton(onPressed: (){
            ...
            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => loginalert(),),);
